"""
    Plugin for streaming NBC Videos
"""
...
__plugin__ = "NBC Video Player"
__pluginid__ = "plugin.video.catchuptv.us.nbc"
...
if ( __name__ == "__main__" ):
    if ( not sys.argv[ 2 ] ):
        ...
        import resources.lib.seasonList as plugin
        plugin.Main()
    elif ( sys.argv[ 2 ].startswith( "?seasonUrl=" ) ):
